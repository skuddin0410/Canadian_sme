...
class RepresentativeUserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax() && $request->ajax_request == true) {
            ...
            $data['offset'] = $offset;
            $data['pageNo'] = $pageNo;
            $users->setPath(route('representative-users.index'));
            $data['html'] = view('users.representative_users.table', compact('users', 'perPage'))
    ...
    {
        //
        return view('users.representative_users.create');
    }
    ...
    if ($validator->fails()) {
        return redirect(route('representative-users.create'))->withInput()
    ...
    return view('users.representative_users.view', compact('user'));
    ...
    return view('users.representative_users.edit', compact('user'));
    }
 ...
 // Remove role association if necessary (optional but clean)
    $user->roles()->detach();
