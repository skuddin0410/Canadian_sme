...
class EmailTemplateSeeder extends Seeder
{
    public function run()
    {
        ...
        EmailTemplate::create([
            ...
            'type' => 'email',
            'message' => 'Dear {{name}},<br><br>This is a friendly reminder that the enter_event_name is coming up soon.<br>Event Details:<br>Date: enter_event_date<br>Time: enter_event_time<br>Location: enter_event_location<br><br>Don’t forget to bring your tickets!<br>Best regards,<br>{{site_name}} Team',
        ]);
        ...
        EmailTemplate::create([
            ...
            'type' => 'email',
            'message' => 'Dear {{name}},<br><br>Welcome to {{site_name}}! We are excited to have you join us.<br>Feel free to explore the site and get started with your first event registration.<br><br>If you have any questions, don’t hesitate to reach out.<br>Best regards,<br>{{site_name}} Team',
        ]);
        ...
        EmailTemplate::create([
            ...
            'type' => 'notifications',
            'message' => 'Hey {{name}}, just a reminder that enter_event_name is happening on enter_event_date at enter_event_location. Don’t miss out!',
        ]);
