...
Route::middleware(['auth:api', 'jwtauth'])->group(function () {
    ...
    Route::post('/exhibitors/{exhibitorId}/files', [App\Http\Controllers\Api\JWTAuthController::class, 'uploadExhibitorFiles']);
    Route::put('/exhibitors/{exhibitorId}/files/{fileId}', [App\Http\Controllers\Api\JWTAuthController::class, 'deleteExhibitorFiles']);
