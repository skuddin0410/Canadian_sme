...
return [
    ...
    */
    ...
    'key' => env('APP_KEY'),
    '2_factor_api_key' => env('2FACTOR_API_KEY'),

    'page_image_size' => env('PAGE_IMAGE_SIZE','5120'),
    'giveaway_image_size' => env('GIVEAWAY_IMAGE_SIZE','5120'),
    'quiz_image_size' => env('QUIZ_IMAGE_SIZE','5120'),
