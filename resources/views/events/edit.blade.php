...
<div class="container-xxl flex-grow-1 container-p-y pt-0">
  <h4 class="py-3 mb-4"><span class="text-muted fw-light">Edit/</span>Event</h4>
  <div class="row">
    <div class="col-xl">
      <div class="card mb-4">
            ...
            <<div class="row">
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    ...
                    <input type="text" class="form-control" name="title" id="slug-source"
                      value="{{ old('title', $e->title ?? '') }}" placeholder="Event Title" />
                  </div>
                  @if ($errors->has('title'))
              ...
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-merge">
                    <span id="title-icon" class="input-group-text"><i class="bx bx-book"></i></span>
                    <input type="text" class="form-control" name="slug" id="slug-target"
                      value="{{ old('slug', $e->slug ?? '') }}" placeholder="Slug" />
                  </div>
                  @if ($errors->has('slug'))
        ...
        <div class="row">
          <div class="col-6">
            <div class="mb-3">
              ...
              <div class="input-group input-group-merge">
                <span id="title-icon" class="input-group-text"><i class="bx bx-book"></i></span>
                <input type="date" class="form-control" name="start_date" id="slug-source"
          ...
          <div class="col-6">
            <div class="mb-3">
              ...
              <div class="input-group input-group-merge">
                <span id="title-icon" class="input-group-text"><i class="bx bx-book"></i></span>
                <input type="date" class="form-control" name="end_date" id="slug-source"
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge" id="quill-editor" style="height: 300px;">
            <textarea type="text" name="description" id="description" class="form-control"
              placeholder="Event Description" rows="8"
              cols="50">{{ old('description', $e->description ?? '') }}</textarea>
          </div>
        ...
        <div class="mb-3">
          <label class="form-label" for="title">Image<span class="text-danger">*</span><span
              class="text-danger">(Allowed file size :
              {{config('app.blog_image_size')." KB and allowed file type ".config('app.image_mime_types') }}) </span>
          </label>
          <div class="input-group input-group-merge">
            <span id="title-icon" class="input-group-text"><i class="bx bx-book"></i></span>
          ...
          <div class="input-group input-group-merge">
            <span class="fw-medium me-2"><img src="{{asset($event->photo->file_path)  ?? ''}}" alt="{{$e->title ?? ''}}"
                height="100px;"></span>
          </div>
          @endif
        </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" class="form-control" name="tags" id="tags"
              value="{{ old('tags', isset($e) ? $e->tags : '') }}" placeholder="Event tags" />
          </div>
          @if ($errors->has('tags'))
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" class="form-control" name="meta_title" id="meta_title"
              value="{{ old('meta_title', $e->meta_title ?? '') }}" placeholder="Event meta title" />
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge" id="quill-editor1" style="height: 300px;">
            <textarea type="text" name="meta_description" id="meta_description" class="form-control"
              placeholder="Event description" rows="8"
              cols="50">{{ old('meta_description', $e->meta_description ?? '') }}</textarea>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" class="form-control" name="meta_keywords" id="meta_keywords"
              value="{{ old('meta_keywords', $e->meta_keywords ?? '') }}" placeholder="Event meta description" />
          </div>
