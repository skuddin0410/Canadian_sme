        ...
        <div class="col-xl">
            <div class="card mb-4">
				<div class="card-header d-flex justify-content-between align-items-center">
				    <h5 class="mb-0">Coupon Lists</h5>
					<div class="dt-action-buttons text-end pt-3 pt-md-0">
						<div class="dt-buttons"> 
                            @if(Auth::user()->hasRole('Admin') || Auth::user()->hasRole('Content Manager'))    
							<a href="{{route('coupons.create')}}" class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                ...
                <form action="#"  method="GET" id="coupons-filter">        
 ...
 function GetCouponList() {
        ...
        $.ajax({
            ...
            success: function (data) {
               $(document).find("#coupon-table").html(data.html);
   ...
   $(document).on("click", ".filter", function(e) {
       ...
       $(".spinner-border").fadeIn(300); 
       $.ajax({
            url: "{{route('coupons.index')}}" + '?' + $("#coupons-filter").serialize(),
            type: 'GET',
            headers: {
                'X-CSRF-Token': $('meta[name="_token"]').attr('content')
            },
