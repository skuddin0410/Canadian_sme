...
@section('title')
Admin | Add Apart Card
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y pt-0">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Home Page / Us Apart / Cards /</span> Add New</h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add Card Details</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.home-page.apart.cards.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" id="order_by" name="order_by" value="{{ old('order_by', 0) }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="profileImageInput" class="form-label">Icon <span class="text-danger">*</span></label>
                                    <div class="d-flex flex-column align-items-center border p-3 rounded bg-light">
                                        <div id="imageNotFoundText" class="mb-2 text-muted fw-bold">No icon selected</div>
                                        <img id="profileImagePreview" src="" alt="Preview" class="img-fluid rounded mb-2 d-none" style="max-height: 150px;">
                                        <input type="file" class="form-control @error('icon') is-invalid @enderror" id="profileImageInput" name="icon" accept="image/*" required>
                                    </div>
                                    @error('icon')
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save me-1"></i> Save Card
                            </button>
