...
@section('title')
Admin | Add Home Review
@endsection

@section('content')
<div class="container-xxl flex-grow-1 container-p-y pt-0">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Home Page / Customer / Home Reviews /</span> Add New</h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Add Review Details</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.home-page.customer.reviews.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="profileImageInput" class="form-label">Profile Image <span class="text-danger">*</span></label>
                                    <div class="d-flex flex-column align-items-center border p-3 rounded bg-light">
                                        ...
                                        <img id="profileImagePreview" src="" alt="Preview" class="img-fluid rounded-circle mb-2 d-none" style="height: 150px; width: 150px; object-fit: cover;">
                        ...
                        <div class="mt-4">
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-plus me-1"></i> Save Review
                            </button>
