...
<style>
    ...
    .sa-card.accent-blue::before  { background: linear-gradient(90deg, #696cff, #696cff); }
    .sa-card.accent-green::before { background: linear-gradient(90deg, #696cff, #696cff); }
    .sa-card.accent-amber::before { background: linear-gradient(90deg, #696cff, #696cff); }
