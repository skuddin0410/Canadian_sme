    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.navbar-dynamic.update', $navbar->id) }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $navbar->title) }}" required>
                                    @error('title')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="slug_preview" value="{{ $navbar->slug }}" readonly disabled>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        <select class="form-select @error('category') is-invalid @enderror" id="category_select" name="category">
                                            ...
                                            @foreach($categories as $cat)
                                                <option value="{{ $cat }}" {{ old('category', $navbar->category) == $cat ? 'selected' : '' }}>{{ $cat }}</option>
                                            @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control description-cls @error('content') is-invalid @enderror" id="description" name="content">{{ old('content', $navbar->content) }}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('order_by') is-invalid @enderror" id="order_by" name="order_by" value="{{ old('order_by', $navbar->order_by) }}" required>
                                    @error('order_by')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
...
<script>
    ...
    cancelNewCat.addEventListener('click', function() {
        ...
        categorySelect.value = "{{ $navbar->category }}";
