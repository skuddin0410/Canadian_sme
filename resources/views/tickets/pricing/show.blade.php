...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="btn-group">
            <a href="{{ route('admin.tickets.pricing.edit', $ticket->id) }}" class="btn btn-warning">
                <i class="fas fa-edit mr-1"></i>Edit Ticket
            </a>
            <a href="{{ route('admin.tickets.pricing.index') }}" class="btn btn-secondary">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in">
                            ...
                            <a class="dropdown-item" href="{{ route('admin.tickets.pricing.edit', $ticket->id) }}">
...
function deleteTicket(ticketId) {
    if (confirm('Are you sure you want to delete this ticket? This action cannot be undone and will affect all related bookings.')) {
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    window.location.href = '{{ route("admin.tickets.pricing.index") }}';
                } else {
