          ...
          <div id="scheduledFields" class="mb-3">
            <div class="row">
              <div class="col-md-6">
                  ...
                  <input type="date" id="start_date" name="start_date" value="{{$page->start_date ?? old('start_date') }}" class="form-control">
              ...
              <div class="col-md-6">
                  ...
                  <input type="date" id="end_date" name="end_date" value="{{$page->end_date ?? old('end_date') }}" class="form-control">
