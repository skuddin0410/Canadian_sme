      ...
      <div class="row g-3 align-items-start">
          <div class="col-md-4">
            <label class="form-label fw-semibold mb-2">
                Profile Photo (<span class="text-danger">600px (width) x 600px (height)</span>)
            </label>
        ...
        <div class="card mb-4">
          <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs" id="attendeeTabs" role="tablist">
              ...
              @if( empty($user->access_speaker_ids) && empty($user->access_exhibitor_ids) && empty($user->access_sponsor_ids) )
              <li class="nav-item" role="presentation">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="col-md-3">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" id="editPermission" name="edit_permission" value="Edit Company" {{$user->can('Edit Company') ? 'Checked' : ''}}>
