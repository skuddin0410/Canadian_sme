    ...
    <div class="col-xl">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="mb-0">Edit Attendee</h5>
        </div>
        <div class="card-body">
          ...
          <form 
            action="{{ route('attendee-users.update', $user->id) }}" 
            method="POST" 
              ...
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <select class="form-control" name="user_type" required>
                    ...
                    <option value="Attendee" {{ old('user_type', $user->roles[0]->name ?? '') == 'Attendee' ? 'selected' : '' }}>Attendee</option>
                  </select>
                </div>
              </div>
