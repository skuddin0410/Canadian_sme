      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          @endif
            ...
            <form  action="@if(!empty($user)) {{ route('representative-users.update',['user'=>$user->id]) }} @else {{ route('representative-users.store') }} @endif " method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
             @if(!empty($user))
             @method('PUT')
            @endif
          ...
          <div class="col-12">
            <div class="mb-3">
              <div class="d-flex pt-3 justify-content-end">
                <a href="{{route('representative-users.index')}}" class="btn btn-outline-primary btn-pill btn-streach font-book ml-3 mt-6 fs-14 me-2">Cancel</a>
