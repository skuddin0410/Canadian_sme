...
@section('title')
    Admin | Exhibitor Representative
@endsection

@section('content')
<div class="container flex-grow-1 container-p-y pt-0">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light"> Exhibitor Representative/</span>Lists</h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
						...
						<div class="dt-buttons"> 
                            <a href="{{route('representative-users.create')}}" class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button">
								<span><i class="bx bx-plus me-sm-1"></i> 
									<span class="d-none d-sm-inline-block">Add Exhibitor Representative </span>
								</span>
							</a> 
