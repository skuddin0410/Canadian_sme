...
<div class="container-xxl flex-grow-1 container-p-y pt-0">
  ...
  <div class="card mb-4">
    <div class="card-body">
      <div class="row g-3 align-items-start">
          <div class="col-md-4">
            <label class="form-label fw-semibold mb-2">Profile Photo (<span class="text-danger">600px (width) x 600px (height)</span>)</label>
  ...
  {{-- MAIN FORM --}}
  <form action="{{ route('speaker.update', $user->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="input-group input-group-merge mb-3">
                          ...
                          <input type="number" name="order_by" class="form-control"
                                 value="{{ old('order_by', $user->order_by) }}" min="0">
                        </div>
