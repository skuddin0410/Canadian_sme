...
<div class="container flex-grow-1 container-p-y pt-0">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Orders</span></h4>
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="col-12 text-right">
                    <form action="#"  method="GET" id="order-filter">        
 ...
 function GetSpinnerList() {
        ...
        $.ajax({
            ...
            success: function (data) {
               $(document).find("#order-table").html(data.html);
  ...
  $(document).on("click", ".filter", function(e) {
       ...
       $(".spinner-border").fadeIn(300);
       $.ajax({
            url: "{{route('orders.index')}}" + '?' + $("#order-filter").serialize(),
            type: 'GET',
            headers: {
                'X-CSRF-Token': $('meta[name="_token"]').attr('content')
            },
