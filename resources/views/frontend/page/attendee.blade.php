                    ...
                    @foreach ($attendees as $attendee)
                        <div class="attendee-card shadow">
                            ...
                            <div class="">
                                ...
                                <span
                                    class="small-heading-black fw-semibold">{{ $attendee->company ? truncateString($attendee->company, 25) : 'NA' }}</span>
                            </div>
                            <div class="">
                                <span class="blue-text-18 mb-2">Job Title</span>
                                <span
                                    class="small-heading-black fw-semibold">{{ $attendee->designation ? truncateString($attendee->designation, 20) : 'NA' }}</span>
                            </div>
                            <div class="">
