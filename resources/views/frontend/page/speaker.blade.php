            ...
            <div class="col-md-4 text-center">
              <a href="{{ route('speaker', ['slug' => $speaker->slug, 'event' => $event->slug ?? '']) }}" class="text-decoration-none">
                <div class="speaker-img-box mb-3">
                  ...
                  @else
                    <img src="{{ asset('frontend/images/No-Image-Placeholder.png') }}" alt="{{ $speaker->full_name }}" 
                         class="img-fluid rounded-circle shadow" style="width: 160px; height: 160px; object-fit: cover;">
                  @endif
                </div>
              </a>
              ...
              <a href="{{ route('speaker', ['slug' => $speaker->slug, 'event' => $event->slug ?? '']) }}" class="btn btn-primary btn-sm px-4 rounded-pill">
                View More
              </a>
            </div>
