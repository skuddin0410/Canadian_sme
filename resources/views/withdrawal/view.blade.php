            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">  
                 ...
                 <div class="d-flex pt-3 justify-content-end">
                       @if($withdrawal->user->kyc_verified == 1 && $withdrawal->user->bank)
                      <a href="#" data-toggle="modal" data-target="#myModal" class="btn btn-outline-success btn-pill btn-streach font-book me-2 mt-10 fs-14" onclick="return confirm('Are you sure you want to approve?')">Approved</a>
                      <a href="{{route("withdrawals-approved-reject",["id"=> $withdrawal->id,'status'=>'failed'])}}" class="btn btn-outline-danger btn-pill btn-streach font-book me-2 mt-10 fs-14" onclick="return confirm('Are you sure you want to reject?')">Reject</a>
                       @endif
                      <a href="{{route("withdrawals-request")}}" class="btn btn-outline-primary btn-pill btn-streach font-book ml-3 mt-6 fs-14">Back</a>
                </div>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Reference  ID<span class="text-danger">*</span></h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      
      <form action="{{route("withdrawals-approved-reject",["id"=> $withdrawal->id,'status'=>'success'])}}" method="GET"> 
        @csrf
      <div class="modal-body">
        <input type="text" value="" name="reference" id="reference" class="form-control" placeholder="Enter reference" maxlength="200" required>
      </div>
